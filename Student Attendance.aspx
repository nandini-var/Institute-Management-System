<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Student Attendance.aspx.cs" Inherits="_Default" %>
...
<body>
    ...
    <div>
        ...
        <div class="style3">
            <strong><span class="style2">Student Attendance Record</span></strong></div>
        <table class="style1">
            <tr>
                <td>
                    &nbsp;</td>
